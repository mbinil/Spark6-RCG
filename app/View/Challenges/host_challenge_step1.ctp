...
<div id="main">       
	<div id="host_challenge_step1">  
		...
		<div class="container_left">
			<div class="btn_next">
			  <a href="javascript:host_challenge_step1('');" class="btn btn-primary btn-block" >Next<span class="fui-arrow-right pull-right"></span></a>
			</div>
			...
			<div class="host_challenge_step1">
				<div style="margin:0px; width:100%; float:left; border: 1px solid #CCCCCC;">
                    <?php echo $user_html;?>
				</div>
			</div>
		</div>   
