...
function getClose()
{
	...
	$.ajax({  //Make the Ajax Request
		type: "POST",  
		url: baseurl+"admin/ajax_createimage",
...
function deletebadgecombo(id,val)
{
	...
	if(checkstr == true){
		$.ajax({  //Make the Ajax Request
			type: "POST",  
			url: baseurl+"admin/badgecombo_delete",
...
<div class="sitemap_nav" style="width:100%;">
  <ul class="nav nav-pills">
	...
	<li class="active"><a href="<?php echo Router::url('/', true); ?>admin/challengeeditstep5/<?php echo $newchallengeinfo[0]['Challenge']['id']; ?>">Image & Color</a></li>
    <li><a>SAVE</a></li>
  </ul>
</div>
<div class="clear"></div>
...
<div class="container_left" style="width:100% !important; border: 1px solid #fff;">
  <div class="btn_next"> <a href="javascript:SaveEditedchallemge();" class="btn btn-primary btn-block">Save<span class="fui-arrow-right pull-right"></span></a> </div>
...
<!--------------------------------------->
  ...
  <div class="Difficulty_step1" style="width:100%; float:left;">
      ...
      <div style="position: absolute; margin: 83px 0 0 0;"> <img src="<?php echo Router::url('/app/webroot/img/challengeuploads/', true).$newchallengeinfo[0]['Challenge']['hero_image']; ?>" height="120"  /> </div>
      <?php } ?>
    <div class="discrption_label">
      <h2>Hero Image</h2>
    </div>
    <div class="clear">&nbsp;</div>
    ...
    <form id="upload" method="post" action="<?php echo Router::url('/admin/challenge_uploads', true); ?>" enctype="multipart/form-data" style="width:710px;float:left;">
      ...
      <div id="drop" style="background-color: white;width:705px;height:120px;"> <br/>
        <br/>
        drop hero image<br/>
    ...
    <div style="width:100%;" align="center">
      <div id="badgecolor" style="margin: 10px 0px; height: 235px;">
        ...
        <div style="float:left;margin: 0px 0 25px 15px;width: 75%;" align="left" class="image_listing">
        ...
        <div class="discrption_label_right" style="float:left;">Need another color? <a href="javascript:getDialogue();" >add one now</a></div>
        <input type="hidden" value="<?php echo $selectedbadgecombo; ?>" id="comboimg">
        <input type="hidden" value="<?php echo $newchallengeinfo[0]['Challenge']['badge_color']; ?>" id="badgecolor_hidden">
      </div>
    </div>
